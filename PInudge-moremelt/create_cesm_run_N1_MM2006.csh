...
#
# Usage:
#	./create_cesm_run_N1_MM2006.csh
#
# Notes:
# 	Pre-industrial everything, winds are historical, with more melt modifications
# 	Initialized from PiC_UVnudge_MM ens mem 1., year 2006
#****************************************************************

## Set option variables in this section
# Set case parameters & name
set CASETITLE=PiC_UVnudge_MM2006
set RES=f09_g17
...
foreach i ( 1 2 3 )
	...
	set NNN=$NNN_arr[$i]
	set REFCASE=${COMPSET_SHORT}.e21.${COMPSET}.${RES}.PiC_UVnudge_MM.${NNN}
	...
	if ($CONT_RUN == FALSE) then
		...
		# Runtime variables
		./xmlchange STOP_OPTION="nyears",RESUBMIT=0,STOP_N=2,JOB_WALLCLOCK_TIME=10:01:00,REST_N=2,REST_OPTION="nyears",CONTINUE_RUN=$CONT_RUN
		...
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1_MM/user_nl_cam .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1_MM/user_nl_clm .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1_MM/user_nl_cice .
		cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1_MM/user_nl_pop .
