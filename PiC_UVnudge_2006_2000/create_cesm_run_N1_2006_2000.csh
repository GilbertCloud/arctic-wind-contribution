...
#
# Usage:
#	./create_cesm_run_N1_2006_2000.csh
#
# Notes:
# 	Pre-industrial everything, winds are historical
# 	Initialized from PiC_UVnudge_2006 ens mem 1., year 2000
#****************************************************************

## Set option variables in this section
# Set case parameters & name
set CASETITLE=PiC_UVnudge_2006_2000
set RES=f09_g17
set COMPSET=B1850cmip6
set COMPSET_SHORT=b
set STARTDATE=1950-01-01

set REFCASE=${COMPSET_SHORT}.e21.${COMPSET}.${RES}.PiC_UVnudge_2006.001
set REFDATE=2000-01-01
...
if ($CONT_RUN == FALSE) then
	...
	cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1/user_nl_cam .
	cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1/user_nl_clm .
	cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1/user_nl_cice .
	cp /glade/u/home/glydia/derecho_case_scripts/namelists/N1/user_nl_pop .
