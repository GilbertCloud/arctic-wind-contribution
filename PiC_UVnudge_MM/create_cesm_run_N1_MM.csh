...
foreach i ( 1 2 3 )
	...
	if ($CONT_RUN == FALSE) then
		...
		# Copy restart files
		cp /glade/derecho/scratch/$USER/archive/$REFCASE/rest/$REFDATE-00000/* /glade/derecho/scratch/$USER/$CASENAME/run/
